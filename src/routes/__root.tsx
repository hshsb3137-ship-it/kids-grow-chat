...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Infinity Learning Center" },
      { property: "og:description", content: "Smart learning materials & classes that make kids fall in love with studying." },
